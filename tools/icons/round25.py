"""Round 25: CODE on a DARK page, because a code file is a dark editor.
...
HEAD = """<meta charset="utf-8"><title>Prism code icon, round 25</title>
<style>
...
def main(out_dir):
    ...
    page_html = "\n".join([
        HEAD,
        """<header>
  <h1>The code icon on a dark page, round 25</h1>
