      ...
      {tabs.map((t, i) => {
        ...
        return (
          <div
            ...
            // every tab after it sideways. Now 106px (owner, 2026-09-21: "way smaller... around 60% of what it
            ...
            // same, on purpose.
            data-tab-fixed
            className={`no-drag group relative flex min-w-[64px] flex-[0_1_106px] items-center gap-1.5 border-r border-[color:var(--p-divider)] px-2.5 transition-colors ${
              loud
                ? ''
                : on
